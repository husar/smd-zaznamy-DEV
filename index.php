                    ...
                    <div class="page-sidebar navbar-collapse collapse">
                        ...
                        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                            ...
                            <li class="heading">
                                ...
                                <li class="nav-item  ">
                                        <a href="?modul=pridat-pouzivatela/vlozit-zaznam" class="nav-link ">
                                            <i class="fa fa-user"></i><span class="title">Pridať používateľa</span>
                                        </a>
                                   </li>   
                                   <li class="nav-item  ">
                                        <a href="?modul=vytvorit-skupinu/vlozit-zaznam" class="nav-link ">
                            ...
                            <li class="nav-item  ">
                                        <a href="?modul=spravovat-pouzivatelov/zaznamy" class="nav-link ">
                                            <i class="fa fa-tasks"></i><span class="title">Spravovať používateľov</span>
                                        </a>
                                   </li> 
							<li class="nav-item  ">
                                        <a href="?modul=spravovat-skupiny/zaznamy" class="nav-link ">
